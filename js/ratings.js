...
import { esc, showToast, closeModals, canEditRatings, canAccessRatings } from './core.js?v=20260915l';
import { PLACEHOLDER_TEAM_IMG } from '../config/config.js?v=20260915l';
