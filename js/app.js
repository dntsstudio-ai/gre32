...
import { FIREBASE_CONFIG, EMAILJS_CONFIG } from '../config/config.js?v=20260915h';
import { navigate, closeModals, showToast, canAccessDubin, canAccessRatings } from './core.js?v=20260915h';
import { initAuthListeners, applyUserUI, resetUserUI, bindAuthActions } from './auth.js?v=20260915h';
import { renderAchProfile, bindAchievements } from './achievements.js?v=20260915h';
import { loadReleases, renderGrid, bindReleases, enableSearch, disableSearch } from './releases.js?v=20260915h';
import { bindComments }    from './comments.js?v=20260915h';
import { bindTeam }        from './team.js?v=20260915h';
import { bindUsers }       from './users.js?v=20260915h';
import { initDubinPanel, bindDubin } from './dubin.js?v=20260915h';
import { bindOrder }       from './order.js?v=20260915h';
import { bindPlaylists }   from './playlists.js?v=20260915h';
import { bindRatings }     from './ratings.js?v=20260915h';
import { bindVCoins, awardVCoins, claimPendingGifts } from './vcoins.js?v=20260915h';
import { bindInventory } from './inventory.js?v=20260915h';
import { bindLootbox } from './lootbox.js?v=20260915h';
import { bindNotifications, listenNotifications } from './notifications.js?v=20260915h';
import { bindUserSearch, bindProfileWall } from './users_search.js?v=20260915h';
import { bindAdminPanel, updateLastSeen, startSessionTimer, incrementPageView } from './admin_panel.js?v=20260915h';
import { bindBanners } from './banners.js?v=20260915h';
import { bindShopSlides } from './shopSlides.js?v=20260915h';
import { checkMaintenance, startMaintenancePolling, injectMaintenanceStyles, prefetchMaintenance } from './maintenance.js?v=20260915h';
