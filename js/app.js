...
import { FIREBASE_CONFIG, EMAILJS_CONFIG } from '../config/config.js?v=20260915k';
import { navigate, closeModals, showToast, canAccessDubin, canAccessRatings } from './core.js?v=20260915k';
import { initAuthListeners, applyUserUI, resetUserUI, bindAuthActions } from './auth.js?v=20260915k';
import { renderAchProfile, bindAchievements } from './achievements.js?v=20260915k';
import { loadReleases, renderGrid, bindReleases, enableSearch, disableSearch } from './releases.js?v=20260915k';
import { bindComments }    from './comments.js?v=20260915k';
import { bindTeam }        from './team.js?v=20260915k';
import { bindUsers }       from './users.js?v=20260915k';
import { initDubinPanel, bindDubin } from './dubin.js?v=20260915k';
import { bindOrder }       from './order.js?v=20260915k';
import { bindPlaylists }   from './playlists.js?v=20260915k';
import { bindRatings }     from './ratings.js?v=20260915k';
import { bindVCoins, awardVCoins, claimPendingGifts } from './vcoins.js?v=20260915k';
import { bindInventory } from './inventory.js?v=20260915k';
import { bindLootbox } from './lootbox.js?v=20260915k';
import { bindNotifications, listenNotifications } from './notifications.js?v=20260915k';
import { bindUserSearch, bindProfileWall } from './users_search.js?v=20260915k';
import { bindAdminPanel, updateLastSeen, startSessionTimer, incrementPageView } from './admin_panel.js?v=20260915k';
import { bindBanners } from './banners.js?v=20260915k';
import { bindShopSlides } from './shopSlides.js?v=20260915k';
import { checkMaintenance, startMaintenancePolling, injectMaintenanceStyles, prefetchMaintenance } from './maintenance.js?v=20260915k';
