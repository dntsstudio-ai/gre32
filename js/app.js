...
import { FIREBASE_CONFIG, EMAILJS_CONFIG } from '../config/config.js?v=20260915b';
import { navigate, closeModals, showToast, canAccessDubin, canAccessRatings } from './core.js?v=20260915b';
import { initAuthListeners, applyUserUI, resetUserUI, bindAuthActions } from './auth.js?v=20260915b';
import { renderAchProfile, bindAchievements } from './achievements.js?v=20260915b';
import { loadReleases, bindReleases, enableSearch, disableSearch } from './releases.js?v=20260915b';
import { bindComments }    from './comments.js?v=20260915b';
import { bindTeam }        from './team.js?v=20260915b';
import { bindUsers }       from './users.js?v=20260915b';
import { initDubinPanel, bindDubin } from './dubin.js?v=20260915b';
import { bindOrder }       from './order.js?v=20260915b';
import { bindPlaylists }   from './playlists.js?v=20260915b';
import { bindRatings }     from './ratings.js?v=20260915b';
import { bindVCoins, awardVCoins, claimPendingGifts } from './vcoins.js?v=20260915b';
import { bindInventory } from './inventory.js?v=20260915b';
import { bindLootbox } from './lootbox.js?v=20260915b';
import { bindNotifications, listenNotifications } from './notifications.js?v=20260915b';
import { bindUserSearch, bindProfileWall } from './users_search.js?v=20260915b';
import { bindAdminPanel, updateLastSeen, startSessionTimer, incrementPageView } from './admin_panel.js?v=20260915b';
import { bindBanners } from './banners.js?v=20260915b';
import { bindShopSlides } from './shopSlides.js?v=20260915b';
import { checkMaintenance, startMaintenancePolling, injectMaintenanceStyles } from './maintenance.js?v=20260915b';
