...
import { FIREBASE_CONFIG, EMAILJS_CONFIG } from '../config/config.js?v=20260915r';
import { navigate, closeModals, showToast, canAccessDubin, canAccessRatings } from './core.js?v=20260915r';
import { initAuthListeners, applyUserUI, resetUserUI, bindAuthActions } from './auth.js?v=20260915r';
import { renderAchProfile, bindAchievements } from './achievements.js?v=20260915r';
import { loadReleases, renderGrid, bindReleases, enableSearch, disableSearch } from './releases.js?v=20260915r';
import { bindVCoins, awardVCoins, claimPendingGifts } from './vcoins.js?v=20260915r';
import { bindNotifications, listenNotifications } from './notifications.js?v=20260915r';
import { bindAdminPanel, updateLastSeen, startSessionTimer, incrementPageView } from './admin_panel.js?v=20260915r';
import { bindBanners } from './banners.js?v=20260915r';
import { checkMaintenance, startMaintenancePolling, injectMaintenanceStyles, prefetchMaintenance } from './maintenance.js?v=20260915r';
