...
import { FIREBASE_CONFIG, EMAILJS_CONFIG } from '../config/config.js?v=20260915i';
import { navigate, closeModals, showToast, canAccessDubin, canAccessRatings } from './core.js?v=20260915i';
import { initAuthListeners, applyUserUI, resetUserUI, bindAuthActions } from './auth.js?v=20260915i';
import { renderAchProfile, bindAchievements } from './achievements.js?v=20260915i';
import { loadReleases, renderGrid, bindReleases, enableSearch, disableSearch } from './releases.js?v=20260915i';
import { bindComments }    from './comments.js?v=20260915i';
import { bindTeam }        from './team.js?v=20260915i';
import { bindUsers }       from './users.js?v=20260915i';
import { initDubinPanel, bindDubin } from './dubin.js?v=20260915i';
import { bindOrder }       from './order.js?v=20260915i';
import { bindPlaylists }   from './playlists.js?v=20260915i';
import { bindRatings }     from './ratings.js?v=20260915i';
import { bindVCoins, awardVCoins, claimPendingGifts } from './vcoins.js?v=20260915i';
import { bindInventory } from './inventory.js?v=20260915i';
import { bindLootbox } from './lootbox.js?v=20260915i';
import { bindNotifications, listenNotifications } from './notifications.js?v=20260915i';
import { bindUserSearch, bindProfileWall } from './users_search.js?v=20260915i';
import { bindAdminPanel, updateLastSeen, startSessionTimer, incrementPageView } from './admin_panel.js?v=20260915i';
import { bindBanners } from './banners.js?v=20260915i';
import { bindShopSlides } from './shopSlides.js?v=20260915i';
import { checkMaintenance, startMaintenancePolling, injectMaintenanceStyles, prefetchMaintenance } from './maintenance.js?v=20260915i';
