...
import { FIREBASE_CONFIG, EMAILJS_CONFIG } from '../config/config.js?v=20260915e';
import { navigate, closeModals, showToast, canAccessDubin, canAccessRatings } from './core.js?v=20260915e';
import { initAuthListeners, applyUserUI, resetUserUI, bindAuthActions } from './auth.js?v=20260915e';
import { renderAchProfile, bindAchievements } from './achievements.js?v=20260915e';
import { loadReleases, renderGrid, bindReleases, enableSearch, disableSearch } from './releases.js?v=20260915e';
import { bindComments }    from './comments.js?v=20260915e';
import { bindTeam }        from './team.js?v=20260915e';
import { bindUsers }       from './users.js?v=20260915e';
import { initDubinPanel, bindDubin } from './dubin.js?v=20260915e';
import { bindOrder }       from './order.js?v=20260915e';
import { bindPlaylists }   from './playlists.js?v=20260915e';
import { bindRatings }     from './ratings.js?v=20260915e';
import { bindVCoins, awardVCoins, claimPendingGifts } from './vcoins.js?v=20260915e';
import { bindInventory } from './inventory.js?v=20260915e';
import { bindLootbox } from './lootbox.js?v=20260915e';
import { bindNotifications, listenNotifications } from './notifications.js?v=20260915e';
import { bindUserSearch, bindProfileWall } from './users_search.js?v=20260915e';
import { bindAdminPanel, updateLastSeen, startSessionTimer, incrementPageView } from './admin_panel.js?v=20260915e';
import { bindBanners } from './banners.js?v=20260915e';
import { bindShopSlides } from './shopSlides.js?v=20260915e';
import { checkMaintenance, startMaintenancePolling, injectMaintenanceStyles, prefetchMaintenance } from './maintenance.js?v=20260915e';
