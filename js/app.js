...
import { FIREBASE_CONFIG, EMAILJS_CONFIG } from '../config/config.js?v=20260906e';
import { navigate, closeModals, showToast, canAccessDubin, canAccessRatings } from './core.js?v=20260906e';
import { initAuthListeners, applyUserUI, resetUserUI, bindAuthActions } from './auth.js?v=20260906e';
import { renderAchProfile, bindAchievements } from './achievements.js?v=20260906e';
import { loadReleases, bindReleases, enableSearch, disableSearch } from './releases.js?v=20260906e';
import { bindComments }    from './comments.js?v=20260906e';
import { bindTeam }        from './team.js?v=20260906e';
import { bindUsers }       from './users.js?v=20260906e';
import { initDubinPanel, bindDubin } from './dubin.js?v=20260906e';
import { bindOrder }       from './order.js?v=20260906e';
import { bindPlaylists }   from './playlists.js?v=20260906e';
import { bindRatings }     from './ratings.js?v=20260906e';
import { bindVCoins, awardVCoins, claimPendingGifts } from './vcoins.js?v=20260906e';
import { bindInventory } from './inventory.js?v=20260906e';
import { bindLootbox } from './lootbox.js?v=20260906e';
import { bindNotifications, listenNotifications } from './notifications.js?v=20260906e';
