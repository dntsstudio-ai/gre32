...
import { esc, showToast, closeModals, showVCoinsPopup } from './core.js?v=20260915j';
import { VCOINS_DEFAULT_PRICES } from '../config/config.js?v=20260915j';
import { checkAndAwardAch } from './achievements.js?v=20260915j';
