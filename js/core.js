// ============================================================
//  js/core.js — Voice Acting Team — Утилиты (Stage 1)
// ============================================================
...
const DUBIN_ACCESS = ['admin','dub','curator','subber','previewer','editor','mixer'];
...
export function navigate(page, pushState) {
    ...
    const sideMap = { profile:'sn-profile', playlists:'sn-playlists', dubin:'sn-dubin',
                      ratings:'sn-ratings', shop:'sn-shop', games:'sn-games', stats:'sn-stats' };
