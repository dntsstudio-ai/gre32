        ...
        try {
            ...
            await setDoc(doc(db,'users',cred.user.uid), {
                ...
                achievements: [{
                    ...
                    desc:'Зарегистрировался на сайте', img:'👋',
...
export function applyUserUI(userData, isAdmin, isDub) {
    ...
    const npl = document.getElementById('n-playlists');
    if (npl) npl.style.display = 'block';
...
export function resetUserUI() {
    ...
    ['adm-btn-rel','adm-btn-team','adm-btn-role','adm-ach-panel','n-dubin','n-playlists'].forEach(id => {
