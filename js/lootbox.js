...
import { esc, showToast } from './core.js?v=20260915f';
import { getRarityByCat, RARITIES, renderCard, addCardToInventory } from './inventory.js?v=20260915f';
import { getOddsMultiplier } from './vcoins.js?v=20260915f';
